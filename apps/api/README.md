...
After `migrate`, two dev users are ensured by migration `users.0002_seed_quake_dev_users`: `admin@Quake.com` (ADMIN) and `staff@Quake.com` (STAFF), both with password `kumar@12`.
