...
export default function DashboardLayout({
  ...
  const topBarConfig = React.useMemo(() => {
    if (!isAdmin && pathname === adminHref("/settings")) {
      return {
        title: "My account",
        subtitle: "Profile and appearance",
        showWarehouse: routeConfig.showWarehouse,
        showDateRange: routeConfig.showDateRange,
      };
    }
    return routeConfig;
  }, [isAdmin, pathname, routeConfig]);
    ...
    <div className="flex min-h-screen bg-[var(--bg-primary)]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <TopBar
          ...
          showWarehouseSelector={topBarConfig.showWarehouse}
          showDateRange={topBarConfig.showDateRange}
          user={user}
        />
